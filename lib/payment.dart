...
class PaymentState extends State<Payment> {
                            ...
                            InkWell(
                              onTap: () => showDialog<String>(
                                ...
                                builder: (BuildContext context) => AlertDialog(
                                  ...
                                  content:
                                      const Text('Voulez vous vraiment payer cette mission ?'),
                                  actions: <Widget>[
                                    TextButton(
                                      onPressed: () =>
  ...
  Future<dynamic> updateState(String Id) async {
    try {
      var url = Uri.parse('http://192.168.1.185/epoka/UpdatePayment.php?ID=$Id');
...
Future<dynamic> getData() async {
  ...
  try {
    var url = Uri.parse('http://192.168.1.185/epoka/GetPayment.php');
    final response = await http.get(url);
